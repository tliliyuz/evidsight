...
- 知识库按 Ledger 行呈现，固定列顺序为“知识库/描述｜可见性｜文档｜索引状态｜最近更新｜操作”；操作表头与右侧按钮列右缘对齐，其余表头与数据左缘对齐，禁止一库一卡。
...
- 文档区按“标题/工具栏｜固定表头｜可滚动行区｜分页/说明”纵向排列；列顺序为“文档｜状态｜有效片段｜更新时间｜操作”，操作表头与按钮列右缘对齐。
