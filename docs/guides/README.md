...
本目录只说明“如何执行”，不定义产品行为、架构边界、接口、权限、数据生命周期或发布门禁。任何指南与 `docs/specs/` 冲突时，以对应权威规范为准并按 [文档治理指南](DOCUMENT_GOVERNANCE.md) 处理。Markdown 的标题、编号、模板与冗余边界统一遵循 [文档格式规范](DOCUMENT_FORMAT.md)。
...
| 文档格式与模板 | [DOCUMENT_FORMAT.md](DOCUMENT_FORMAT.md) | [文档治理指南](DOCUMENT_GOVERNANCE.md) |
