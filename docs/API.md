...
```
event: meta
data: {"conversation_id": 5, "task_id": "c3d4e5f6-a7b8-9012-cdef-123456789012"}
...
```
event: meta
data: {"conversation_id": 3, "task_id": "d4e5f6a7-b8c9-0123-defa-234567890123"}
