...
class TestChatRequestSchema:
    ...
    def test_question空应报错(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ChatRequest(kb_id="aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa", question="")
    ...
    def test_question超长应报错(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ChatRequest(kb_id="aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa", question="x" * 2001)
        errors = exc_info.value.errors()
        assert any(e["loc"] == ("question",) for e in errors)
    ...
    def test_conversation_id可选默认None(self):
        ...
        req = ChatRequest(kb_id="aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa", question="测试问题")
    ...
    def test_正常请求全部字段(self):
        ...
        assert req.conversation_id == "bbbbbbbb-bbbb-4bbb-bbbb-bbbbbbbbbbbb"
        assert req.kb_id == "aaaaaaaa-aaaa-4aaa-aaaa-aaaaaaaaaaaa"
