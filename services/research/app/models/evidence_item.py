...
class EvidenceItem(Base):
    ...
    source_type: Mapped[str] = mapped_column(
        sa.Enum(
            EVIDENCE_SOURCE_TYPE_INTERNAL, EVIDENCE_SOURCE_TYPE_WEB, name="evidence_source_type"
        ),
    ...
    validity: Mapped[str] = mapped_column(
        sa.Enum(
            EVIDENCE_VALIDITY_AVAILABLE,
            EVIDENCE_VALIDITY_RESTRICTED,
            EVIDENCE_VALIDITY_MISSING,
            EVIDENCE_VALIDITY_STALE,
